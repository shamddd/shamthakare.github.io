...
pdf_path = os.path.join(base_dir, "final_manuscript.pdf")
pdf_sub_path = os.path.join(base_dir, "IEEE_TAI_submission.pdf")
...
# Custom styles matching IEEE TAI
...
# Author Line
story.append(Paragraph("Sham Satish Thakare, <i>Independent Researcher</i><br/><font size=8 color='#475569'>Pune, Maharashtra 411001, India &bull; Email: shamthakare3000@gmail.com</font>", author_style))
...
story.append(Paragraph("<b>Sham Satish Thakare</b> is an Independent Computer Science Researcher based in Pune, India. His research interests focus on distributed systems, fault-tolerant consensus algorithms, and performance optimization for cloud infrastructure.", ParagraphStyle('BioStyle', parent=body_style, fontSize=8.5, leading=11)))

doc.build(story)

# Also copy to IEEE_TAI_submission.pdf
import shutil
shutil.copyfile(pdf_path, pdf_sub_path)

print("Successfully generated PDF files:")
print("  ", pdf_path)
print("  ", pdf_sub_path)
