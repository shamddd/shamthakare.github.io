...
# ------------------------------------------------------------------------------
# 1. Build Anonymized_IEEE_TAI_Manuscript.docx
# ------------------------------------------------------------------------------
...
r_kw_h.bold = True
p_kw.add_run("Artificial intelligence, Autonomous agent infrastructure, Distributed consensus, Fault tolerance, Quorum adaptation, Raft protocol, Reliability, Tail latency.")
...
doc.save(docx_path)
print("Successfully generated Anonymized_IEEE_TAI_Manuscript.docx")

# ------------------------------------------------------------------------------
# 2. Build Anonymized_IEEE_TAI_Manuscript.pdf & IEEE_TAI_submission.pdf
# ------------------------------------------------------------------------------
...
print("Successfully generated Anonymized_IEEE_TAI_Manuscript.pdf & IEEE_TAI_submission.pdf")
