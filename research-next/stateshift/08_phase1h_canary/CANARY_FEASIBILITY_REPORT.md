# TECHNICAL CHECKPOINT CANARY FEASIBILITY REPORT (RECONCILED V2)

**Milestone**: Phase 1H.1 Technical Checkpoint Canary Execution & Reconciliation  
**Execution Timestamp**: `2026-08-18 20:18 UTC`  
...
| :--- | :---: | :---: | :---: |
| **Model Load Duration** | `2.49s` | `47.29s` | `49.78s` (Total) |
| **Mean Generation Duration** | `978.34s` | `3663.67s` | **`2321.00s`** |
| **Median Generation Duration** | — | — | **`1829.63s`** |
...
- **Estimated CPU Compute-Hours (Mean)**: **`84670.3 CPU-Hours`** (~`9.67` CPU-Years)
- **Estimated CPU Compute-Hours (Median Range)**: **`66744.9 CPU-Hours`** (~`7.62` CPU-Years)
