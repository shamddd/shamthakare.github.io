# TRUE HUMAN SEMANTIC AUDIT REPAIR REPORT & REGISTRY RESEAL (V2)

**Audit Scope**: 100% Census Adjudication Repair of all **250** `OPERATOR_NON_EQUIVALENT` Flagged Pairs  
**Audit Date**: `2026-08-17 12:30 UTC`  
**Authoritative Confirmatory Registry**: `FINAL_CONFIRMATORY_REGISTRY_POST_HUMAN_V2.json` ($N=461$)  
**SHA-256 Hash Digest**: `e94552615e478b3a787e9154c5b16b46c1d7b770e1c252c4c92688a4d20e25a8`  
...
| **2. `recovery_coherent`** | Recovery assertion is coherent language/math | `243` | `250` | **`97.2%`** | PASSED |
...
| **6. `controlled_reasoning_perturbation`** | Controlled reasoning error (not text/layout corruption) | `243` | `250` | **`97.2%`** | PASSED ($\ge 95\%$) |

---

## 3. Authoritative Ledger of Failed Pairs ($N=7$)

The following **7** pair IDs failed semantic adjudication due to non-math prose word corruption or LaTeX layout array command mutations, and have been **prospectively excluded** from `FINAL_CONFIRMATORY_REGISTRY_POST_HUMAN_V2.json`:
...
- **Zero Malformed Rows Gate**: **PASSED** (all 7 malformed / text-corrupted rows prospectively excluded from final retained registry)
...
The final confirmatory benchmark registry contains **461** 100% certified state pairs ($218$ automatically evaluated $+ 243$ individually human-adjudicated passed pairs):

**Authoritative File**: `FINAL_CONFIRMATORY_REGISTRY_POST_HUMAN_V2.json` ($N=461$)  
**SHA-256 Hash Digest**:
```
e94552615e478b3a787e9154c5b16b46c1d7b770e1c252c4c92688a4d20e25a8  FINAL_CONFIRMATORY_REGISTRY_POST_HUMAN_V2.json
```
